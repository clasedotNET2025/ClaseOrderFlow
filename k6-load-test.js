...
export const options = {
    ...
    stages: [
        ...
        { duration: '30s', target: 3 },   // Ramp to 30 users
        { duration: '30s', target: 6 },   // Ramp to 60 users
        { duration: '30s', target: 10 },  // Ramp to 100 users
        { duration: '20s', target: 10 },  // Stay at 100 users
